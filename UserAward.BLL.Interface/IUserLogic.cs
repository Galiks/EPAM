...
namespace UserAward.BLL.Interface
{
    ...
    {
        bool AddUser(string name, string birthday, string email, string password, string role, byte[] userPhoto);
        ...
        bool UpdateUser(string id, string name, string birthday, string email, string password, string role, byte[] userPhoto);
